                ...
                <div class="col-xs-6">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title"><span class="text-blue">Create New Landscape Photo</span> </h3>
                        </div>

                        <div class="box-body">
                            <form action="{{ route('store_landscape_photo') }}" method="post" enctype="multipart/form-data">
