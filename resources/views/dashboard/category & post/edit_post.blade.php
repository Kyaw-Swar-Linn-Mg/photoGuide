                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('update_post') }}" method="post" enctype="multipart/form-data">
                                ...
                                @foreach(json_decode($post->filename) as $key=>$value)
                                    <div class="col-sm-6 col-md-6 col-lg-6" id="{{$key}}">
                                        <div class="thumbnail">
                                            <div class="frow">
                                                <button type="button" key={{$key}} name="{{$value}}" id="{{$post->id}}" class="btnRemove btn-sm text-danger pull-right"><span class="fa fa-remove"></span></button>
                                            </div>
                                            <div class="secrow" style="text-align: center;">
                                                <img class="img" src="{{asset('/photo_guide/post/'.$value)}}" width="100px" height="100px">
                                            </div>
                                        </div>
                                    </div>
